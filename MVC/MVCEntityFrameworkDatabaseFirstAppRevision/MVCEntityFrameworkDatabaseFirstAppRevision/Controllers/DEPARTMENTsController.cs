...
namespace MVCEntityFrameworkDatabaseFirstAppRevision.Controllers
{
    public class DEPARTMENTsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "DEPTID,DEPTNAME,DEPTLOC")] DEPARTMENT dEPARTMENT)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "DEPTID,DEPTNAME,DEPTLOC")] DEPARTMENT dEPARTMENT)
        {
            if (ModelState.IsValid)
            {
