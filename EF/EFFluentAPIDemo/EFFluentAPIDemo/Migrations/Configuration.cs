namespace EFFluentAPIDemo.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<EFFluentAPIDemo.AppDBContext>
    {
        ...
        protected override void Seed(EFFluentAPIDemo.AppDBContext context)
        {
